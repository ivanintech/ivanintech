...
Revision ID: 7a28c0f593ca
Revises: 
Create Date: 2025-06-30 21:55:05.832675
...
def upgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS resource_votes CASCADE;")
    op.execute("DROP TABLE IF EXISTS blog_suggestions CASCADE;")
    op.execute("DROP TABLE IF EXISTS news_items CASCADE;")
    op.execute("DROP TABLE IF EXISTS resource_links CASCADE;")
    op.execute("DROP TABLE IF EXISTS item CASCADE;")
    op.execute('DROP TABLE IF EXISTS "blog_posts" CASCADE;')
    # Drop standalone tables
    op.execute('DROP TABLE IF EXISTS "projects" CASCADE;')
    op.execute("DROP TABLE IF EXISTS hero_media CASCADE;")
    op.execute("DROP TABLE IF EXISTS contact_messages CASCADE;")
    op.execute("DROP TABLE IF EXISTS about_media CASCADE;")
    # Drop types
    ...
    sa.Column('published_date', sa.Date(), server_default=sa.text('(CURRENT_DATE)'), nullable=False),
