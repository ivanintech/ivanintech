...
interface AboutMeClientPageProps {
    imagePaths: string[];
}

export function AboutMeClientPage({ imagePaths }: AboutMeClientPageProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="space-y-4 text-muted-foreground dark:text-muted-foreground">
              <p>
                I transform abstract concepts into tangible solutions by bridging the gap between user needs and technical execution. My process is rooted in a product-driven mindset: I dive deep to understand the &apos;why&apos; behind every feature, ensuring that the end result not only works, but provides genuine, measurable value.
              </p>
              <p>
